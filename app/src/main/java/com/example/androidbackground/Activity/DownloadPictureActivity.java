...
public class DownloadPictureActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static void actionStart(Context context, List<String> tag, Double atime, int ranks, int views,
        ...
        Intent intent = new Intent(context, DownloadPictureActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentUrl = "http://service.picasso.adesk.com/v2/vertical/vertical/" + id + "/comment";
        pictureUrl = "http://service.picasso.adesk.com/v1/vertical/vertical/" + id;
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(DownloadPictureActivity.this, "刷新完毕！", Toast.LENGTH_SHORT).show();
    ...
    private void getPictureData() {
        httpConnect = new HttpConnect(pictureUrl);
        httpConnect.sendRequestWithHttpURLConnection(new HttpConnect.Callback() {
            @Override
            public void finish(String respone) {
                Gson gson = new Gson();
                PictureGson pictureGson = gson.fromJson(respone, PictureGson.class);
                PictureGson.ResBean.VerticalBean verticalBean = pictureGson.getRes().getVertical();
                atime = verticalBean.getAtime();
                ranks = verticalBean.getRank();
                views = verticalBean.getViews();
                favs = verticalBean.getFavs();
                }
            });
    }
    ...
    private void initView() {
        ...
        //加载图片
        Picasso.with(DownloadPictureActivity.this).load(url).placeholder(R.drawable.tacitly_approve_type).
                error(R.drawable.wrong_picture).into(iv_specificPicture);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_wp:
                Toast.makeText(DownloadPictureActivity.this, "下载完成！", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.iv_rank:
                ...
                if (user_rank == 0) {
                    ...
                    Toast.makeText(DownloadPictureActivity.this, "已点赞！", Toast.LENGTH_SHORT).show();
                    user_rank = 1;
                } else if (user_rank == 1) {
                    iv_rank.setImageResource(R.drawable.rank);
                    editor.putInt("user_rank" + id, 0);
                    Toast.makeText(DownloadPictureActivity.this, "已取消点赞！", Toast.LENGTH_SHORT).show();
                    user_rank = 0;
                } else {
                    editor.putInt("user_rank" + id, 0);
                    iv_rank.setImageResource(R.drawable.rank);
            ...
            case R.id.iv_favs:
                ...
                if (user_fav == 0) {
                    ...
                    Toast.makeText(DownloadPictureActivity.this, "已收藏！", Toast.LENGTH_SHORT).show();
                    user_fav = 1;
                } else if (user_fav == 1) {
                    iv_favs.setImageResource(R.drawable.fav);
                    editor1.putInt("user_fav" + id, 0);
                    Toast.makeText(DownloadPictureActivity.this, "已取消收藏！", Toast.LENGTH_SHORT).show();
                    user_fav = 0;
                } else {
                    editor1.putInt("user_fav" + id, 0);
                    iv_favs.setImageResource(R.drawable.fav);
            ...
            case R.id.comment_new:
                new CommentActivity().actionStart(DownloadPictureActivity.this, commentUrl);
                break;
        }
    }
